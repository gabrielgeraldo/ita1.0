...
public class RelatorioMB implements Serializable {
	...
	@NotEmpty(message = "Selecione as poss�veis situa��es.")
	...
	public void gerarRelatorio() {
		try {
			 ...
			 * .getResponse(); res.setContentType("application/pdf"); // C�digo
			 * abaixo gerar o relat�rio e disponibiliza diretamente na // p�gina
			 * res.setHeader("Content-Disposition",
			 * "inline; filename=Relatorio.pdf"); // C�digo abaixo gerar o
			 * relat�rio e disponibiliza para o cliente // baixar ou salvar //
			 * res.setHeader("Content-disposition", //
			...
			JSFUtil.retornarMensagemInfo("Relat�rio gerado com sucesso!", null, null);

		} catch (JRException erro) {
			erro.printStackTrace();
			JSFUtil.retornarMensagemErro("Erro ao gerar relat�rio!", null, null);
		} catch (java.lang.NullPointerException erro) {
			System.out.println("Erro/Fala: (java.lang.NullPointerException))");
			erro.printStackTrace();
			JSFUtil.retornarMensagemErro("Falha ao gerar relat�rio!", erro.getMessage(), null);
