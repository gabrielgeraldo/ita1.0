...
public class TotaisPorDiaMB implements Serializable {
	...
	public String acaoRelatorios() {
		return "/Relatorio/totaisPorDia?faces-redirect=true";
	}
		...
		try {
			...
			if (this.tipoRelatorio.equals("nfce")) {
				...
				caminho = FacesContext.getCurrentInstance().getExternalContext()
						.getRealPath("/report/totaisPorDiaNFCe.jasper");

			} else if (this.tipoRelatorio.equals("nfe")) {

				caminho = FacesContext.getCurrentInstance().getExternalContext()
						.getRealPath("/report/totaisPorDiaNFe.jasper");

			} else if (this.tipoRelatorio.equals("venda")) {

				caminho = FacesContext.getCurrentInstance().getExternalContext()
						.getRealPath("/report/totaisPorDiaVenda.jasper");
