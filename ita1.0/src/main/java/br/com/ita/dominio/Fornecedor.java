...
public class Fornecedor implements BaseEntity, Serializable {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "codigo_fornecedor")
	@SequenceGenerator(sequenceName = "codigo_fornecedor", name = "codigo_fornecedor", allocationSize = 1)
	private Long codigo;
